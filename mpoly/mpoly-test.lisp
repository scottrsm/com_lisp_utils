...
(defun run-mpoly-tests ()
  ...
  (with-tests (:name "MULTIVARIATE POLYNOMIAL TESTS")
    ...
    (let ((previous-mod (rsm.mpoly:get-modulus)))
      (unwind-protect 
          (progn
            
            ;; Set the modulus to nil for the following tests.
            (rsm.mpoly:set-modulus nil :field? nil)
            ...
            (test (rsm.mpoly:poly (-60 (4 2)) (-12 (3 4)) (-300 (3 3)) 
                                  (156 (3 2)) (-60 (2 5)) (36 (2 4)) 
                                  (-120 (2 3)) (72 (2 2)))
            ...
            (test (rsm.mpoly:poly (1000 (6 3)) (600 (5 5)) (1200 (5 3)) 
                                  (120 (4 7)) (480 (4 5)) (480 (4 3)) 
                                  (8 (3 9)) (48 (3 7)) (96 (3 5)) (64 (3 3)))
                  (rsm.mpoly:^ *foo* 3)
                  :test #'equalp
                  :fail-info "Test 10"))
        (rsm.mpoly:set-modulus (car previous-mod) :field? (cdr previous-mod))))
    
    (let ((previous-mod (rsm.mpoly:get-modulus)))
      (unwind-protect
          (progn
            
            ;; Set the modulus for the next tests.
            (rsm.mpoly:set-modulus 5 :field? t)
            
            (test (rsm.mpoly:poly (2 (1 3)) (10 (2 1)) (4 (1 1)) (3 (0 0)))
                  (rsm.mpoly:+ *foo* 18)
                  :test #'equalp
                  :fail-info "Test 11")
            
            (test (rsm.mpoly:poly (2 (1 3)) (10 (2 1)) (4 (1 1)) (18 (0 0)))
                  (rsm.mpoly:+ *foo* 18)
                  :test #'equalp
                  :fail-info "Test 12"))
    ...
    (let ((previous-mod (rsm.mpoly:get-modulus)))      
      ...
      (unwind-protect
          (progn
            ...
            (rsm.mpoly:set-modulus 17 :field? t)
            (test (rsm.mpoly:poly 
    ...
    (let ((previous-mod (rsm.mpoly:get-modulus)))      
      (unwind-protect
          (progn
            ;; Set the modulus for the next test.
            (rsm.mpoly:set-modulus 4 :field? nil)
            
            (test (rsm.mpoly:poly (3.2 (1 1)) (3 (1 2)) (-1 (2 1)))
                  *doo*
                  :test #'rsm.mpoly:poly=
                  :fail-info "Test 14"))
      ...
      (unwind-protect
          (progn
            ...
            (unwind-protect
              ...
              (rsm.mpoly:set-order lex)))
            
        ;; Unset the modulus for the next test.
        (rsm.mpoly:set-modulus (car previous-mod) :field? 
                               (cdr previous-mod))))
    
    (test (rsm.mpoly:make-zero-poly *foo*)
          (rsm.mpoly:- *foo* *foo*)
          :test #'equalp
          :fail-info "Test 16")
    
    (test (rsm.mpoly:poly (11 (2 1)) (2 (1 3)) (5 (1 2)) (1 (1 1)) (-3 (0 0)))
          (rsm.mpoly:- *foo* *goo* 3)
          :test #'equalp
          :fail-info "Test 17")
    
    (test (rsm.mpoly:poly (-11 (2 1)) (-2 (1 3)) (-5 (1 2)) (-1 (1 1)) 
                          (-3 (0 0)))
          (rsm.mpoly:- *goo* *foo* 3)
          :test #'equalp
          :fail-info "Test 18")
    ...
    (test (rsm.mpoly:poly (6 (2 1)) (#c(-3 -4) (1 2)) (-1.2 (1 1)) (3 (1 0))
                                                            (11 (0 0)))
          (rsm.mpoly:- *boo* *doo*)
          :test #'equalp
          :fail-info "Test 22")
